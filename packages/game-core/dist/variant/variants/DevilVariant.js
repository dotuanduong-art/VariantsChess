...
exports.DevilVariant = {
    id: 'devil',
    name: 'Devil',
    description: 'Unleash infernal pacts, reactive stuns, berserk curses, and toll charges on your enemies.',
    effectHandlers: [
        new DevilEyeHandler_1.DevilEyeHandler(),
        new DevilTollHandler_1.DevilTollHandler(),
        new BerserkHandler_1.BerserkHandler(),
    ],
    getInitialState: () => ({
    ...
    skills: [
        {
            ...
            tier: 'skill1',
            apCost: apCostConfig_1.APCostConfig.devil.devil_skill_1,
            cooldown: 0,
        ...
        },
        {
            ...
            tier: 'skill2',
            apCost: apCostConfig_1.APCostConfig.devil.devil_skill_2,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [{
                    type: 'piece',
        ...
        },
        {
            ...
            tier: 'ultimate',
            apCost: apCostConfig_1.APCostConfig.devil.devil_ultimate,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [],
            canActivate(state, player, targets) {
...
//# sourceMappingURL=DevilVariant.js.map