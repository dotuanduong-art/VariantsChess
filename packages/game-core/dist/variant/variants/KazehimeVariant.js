...
exports.KazehimeVariant = void 0;
exports.getCrossCells = getCrossCells;
exports.getXCells = getXCells;
const Piece_1 = require("../../pieces/Piece");
const Board_1 = require("../../board/Board");
const RepelHandler_1 = require("../../effect/handlers/RepelHandler");
...
exports.KazehimeVariant = {
    ...
    passiveHooks: (state, player) => [
        {
            ...
            handler: (event, enqueueAction) => {
                ...
                if (!storm)
                    return;
                const enemyColor = player === Piece_1.Color.White ? Piece_1.Color.Black : Piece_1.Color.White;
                ...
                for (let r = 0; r < Board_1.BOARD_SIZE; r++) {
                    for (let c = 0; c < Board_1.BOARD_SIZE; c++) {
                        ...
                        if (piece && piece.color === enemyColor && piece.type !== Piece_1.PieceType.King) {
    ...
    skills: [
        // ── Skill 1: Wind Reversal (1 AP) ──
        {
            ...
            tier: 'skill1',
            apCost: apCostConfig_1.APCostConfig.kaze.kaze_skill_1,
            cooldown: 0,
            ...
            canActivate(state, player, targets) {
                ...
                for (const c of cells) {
                    ...
                    const hasExistingTrap = state.board.getCellEffects(c).some(e => e.type === 'repel' || e.type === 'soulless_cell');
                    if (hasExistingTrap) {
        ...
        // ── Skill 2: Illusory Wind (2 AP) ──
        {
            ...
            tier: 'skill2',
            apCost: apCostConfig_1.APCostConfig.kaze.kaze_skill_2,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [{
                    type: 'cell',
        ...
        // ── Ultimate: Eye of the Divine Storm (11 AP) ──
        {
            ...
            tier: 'ultimate',
            apCost: apCostConfig_1.APCostConfig.kaze.kaze_ultimate,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [{
                    type: 'cell',
            ...
            execute(state, player, targets, rng) {
                ...
                for (const [key, effects] of allCellEffects.entries()) {
                    const matchEffects = effects.filter(e => (e.type === 'repel' || e.type === 'soulless_cell') && e.sourcePlayer === player);
...
//# sourceMappingURL=KazehimeVariant.js.map