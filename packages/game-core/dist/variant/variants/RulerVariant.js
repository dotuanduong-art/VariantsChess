...
exports.RulerVariant = exports.DomainBoundaryModifier = exports.LawValidator = void 0;
...
// ─────────────────────────────────────────────────────────────────────────────
function getPieceRank(type) {
    switch (type) {
        case Piece_1.PieceType.King: return 6;
        case Piece_1.PieceType.Queen: return 5;
        case Piece_1.PieceType.Rook: return 4;
        case Piece_1.PieceType.Bishop: return 3;
        case Piece_1.PieceType.Knight: return 2;
        case Piece_1.PieceType.Pawn: return 1;
        default: return 0;
    }
}
// ─────────────────────────────────────────────────────────────────────────────
...
exports.RulerVariant = {
        ...
        },
        {
            ...
            handler: (event) => {
                if (event.type !== 'OnPieceDestroyed')
                    return;
                if (!state.variantState.domainActive)
                    return;
                ...
                if (color === Piece_1.Color.White && state.variantState.domainWhitePiecesInside) {
                ...
                else if (color === Piece_1.Color.Black && state.variantState.domainBlackPiecesInside) {
                ...
                if (wasRemoved) {
                    if (color === Piece_1.Color.White && state.variantState.domainWhitePiecesInside.length === 0) {
                        state.variantState.domainActive = false;
                        state.variantState.domainWhitePiecesInside = [];
                        state.variantState.domainBlackPiecesInside = [];
                    }
                    else if (color === Piece_1.Color.Black && state.variantState.domainBlackPiecesInside.length === 0) {
                        state.variantState.domainActive = false;
                        state.variantState.domainWhitePiecesInside = [];
                        state.variantState.domainBlackPiecesInside = [];
                    }
    ...
    skills: [
        // ── Skill 1: Order of Hierarchy (4 AP) ──
        {
            ...
            tier: 'skill1',
            apCost: apCostConfig_1.APCostConfig.ruler.ruler_skill_1,
            cooldown: 0,
        ...
        // ── Skill 2: Decree of the Weak (4 AP) ──
        {
            ...
            tier: 'skill2',
            apCost: apCostConfig_1.APCostConfig.ruler.ruler_skill_2,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [],
            canActivate(state) {
        ...
        // ── Ultimate: Absolute Domain (10 AP) ──
        {
            ...
            tier: 'ultimate',
            apCost: apCostConfig_1.APCostConfig.ruler.ruler_ultimate,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [],
            canActivate() {
...
//# sourceMappingURL=RulerVariant.js.map