...
const RESURRECT_AP_MAP = {
    [Piece_1.PieceType.Pawn]: apCostConfig_1.APCostConfig.phoenix.phoenix_table.Pawn,
    [Piece_1.PieceType.Knight]: apCostConfig_1.APCostConfig.phoenix.phoenix_table.Knight,
    [Piece_1.PieceType.Bishop]: apCostConfig_1.APCostConfig.phoenix.phoenix_table.Bishop,
    [Piece_1.PieceType.Rook]: apCostConfig_1.APCostConfig.phoenix.phoenix_table.Rook,
    [Piece_1.PieceType.Queen]: apCostConfig_1.APCostConfig.phoenix.phoenix_table.Queen,
    [Piece_1.PieceType.King]: 999, // Cannot resurrect King
};
exports.PhoenixVariant = {
    id: 'phoenix',
    name: 'Phoenix',
        ...
        // Supernova timer check at the start of EVERY turn (both White and Black)
        {
            ...
            handler: (event, enqueueAction) => {
                ...
                if (supernova && supernova.active) {
                    ...
                    const currentPly = (turnNumber - 1) * 2 + (activePlayer === Piece_1.Color.White ? 0 : 1);
                    if (currentPly >= supernova.detonationPly) {
                        const center = supernova.center;
                        const region = (0, Region_1.getSquareRegion)(center, 7);
    ...
    skills: [
        // ── Skill 1: Ashes of Reanimation (Dynamic AP) ──
        {
            ...
            tier: 'skill1',
            apCost: apCostConfig_1.APCostConfig.phoenix.phoenix_skill_1, // Base apCost evaluated by validator. Extra is spent during execute.
            cooldown: 0,
            ...
            canActivate(state, player, targets) {
                ...
                if (graveyardEntry.piece.type === Piece_1.PieceType.King) {
                ...
                const actualCost = RESURRECT_AP_MAP[graveyardEntry.piece.type];
            ...
            execute(state, player, targets) {
                ...
                const actualCost = RESURRECT_AP_MAP[resurrectedPiece.type];
        ...
        // ── Skill 2: Solar Flare (5 AP) ──
        {
            ...
            tier: 'skill2',
            apCost: apCostConfig_1.APCostConfig.phoenix.phoenix_skill_2,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements(state, player) {
                return [
            ...
            canActivate(state, player, targets) {
                ...
                const bishopAttacks = attacks.filter(atk => atk.attacker.type === Piece_1.PieceType.Bishop &&
            ...
            execute(state, player, targets) {
                ...
                const region = (0, Region_1.getSquareRegion)(targetPos, 5);
                for (const pos of region) {
                    actions.push({
                        type: 'APPLY_EFFECT',
                        effect: {
        ...
        // ── Ultimate: Supernova (11 AP) ──
        {
            ...
            tier: 'ultimate',
            apCost: apCostConfig_1.APCostConfig.phoenix.phoenix_ultimate,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements(state, player) {
                return [
            ...
            execute(state, player, targets) {
                ...
                const currentPly = (state.turnNumber - 1) * 2 + (player === Piece_1.Color.White ? 0 : 1);
...
//# sourceMappingURL=PhoenixVariant.js.map