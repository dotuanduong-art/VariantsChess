...
exports.TimeVariant = {
    ...
    effectHandlers: [
        new PredictionHandler_1.PredictionHandler(),
        new TimeFreezeHandler_1.TimeFreezeHandler(),
    ],
    getInitialState: () => ({
        ultimateUseCount: 0,
    }),
    skills: [
        // ── Skill 1: Rewind (4 AP) ──
        {
            ...
            tier: 'skill1',
            apCost: apCostConfig_1.APCostConfig.time.time_skill_1,
            cooldown: 0,
        ...
        // ── Skill 2: Future Prediction (5 AP) ──
        {
            ...
            tier: 'skill2',
            apCost: apCostConfig_1.APCostConfig.time.time_skill_2,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements(state, player) {
                return [
        ...
        // ── Ultimate Option A: Grand Rewind (AP theo Passive) ──
        {
            ...
            apCost: (state, player) => {
                ...
                return apCostConfig_1.APCostConfig.time.time_ultimate[Math.min(count, 2)];
            },
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements(state, player) {
...
//# sourceMappingURL=TimeVariant.js.map