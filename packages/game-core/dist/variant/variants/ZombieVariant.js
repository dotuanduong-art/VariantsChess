...
exports.ZombieVariant = void 0;
const ZombieHandler_1 = require("../../effect/handlers/ZombieHandler");
const WalkerHandler_1 = require("../../effect/handlers/WalkerHandler");
const apCostConfig_1 = require("../apCostConfig");
function countZombiesOnBoard(state, player) {
    let count = 0;
    for (let r = 0; r < 15; r++) {
        for (let c = 0; c < 15; c++) {
...
exports.ZombieVariant = {
    ...
    effectHandlers: [
        new ZombieHandler_1.ZombieHandler(),
        new WalkerHandler_1.WalkerHandler(),
    ],
    getInitialState: () => ({
    ...
    skills: [
        {
            ...
            apCost(state, player) {
                ...
                return freeCount > 0 ? 0 : apCostConfig_1.APCostConfig.zombie.zombie_skill_1;
            },
            cooldown: 0,
        ...
        },
        {
            ...
            tier: 'skill2',
            apCost: apCostConfig_1.APCostConfig.zombie.zombie_skill_2,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [{
                    type: 'piece',
        ...
        },
        {
            ...
            tier: 'ultimate',
            apCost: apCostConfig_1.APCostConfig.zombie.zombie_ultimate,
            cooldown: 0,
            usageRule: 'once_per_turn',
            getTargetRequirements: () => [],
            canActivate(state, player, targets) {
                const eligibleEntries = state.graveyard.filter(entry => entry.piece.color === player &&
...
//# sourceMappingURL=ZombieVariant.js.map