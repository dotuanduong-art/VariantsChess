...
exports.ThunderFangHandler = void 0;
 ...
 */
class ThunderFangHandler {
    effectType = 'thunder_fang';
    subscribesTo = ['OnCapture', 'OnTurnEnd'];
    handle(event, state, enqueueAction) {
        ...
        if (!attacker || attacker.id !== attackerId) {
            ...
            for (let r = 0; r < Board_1.BOARD_SIZE && !attacker; r++) {
                for (let c = 0; c < Board_1.BOARD_SIZE && !attacker; c++) {
        ...
        return {
            ...
            modify(moves, context) {
                ...
                for (const { dc, dr } of directions) {
                    for (let dist = 1; dist < Board_1.BOARD_SIZE; dist++) {
...
exports.ThunderFangHandler = ThunderFangHandler;
//# sourceMappingURL=ThunderFangHandler.js.map