...
exports.SoullessCellHandler = void 0;
class SoullessCellHandler {
    effectType = 'soulless_cell';
    ...
    handle(event, state, enqueueAction) {
        ...
        const soullessCell = cellEffects.find(e => e.type === 'soulless_cell' && e.sourcePlayer !== piece.color);
        if (soullessCell) {
            ...
            for (const [key, effects] of allCellEffects.entries()) {
                const matching = effects.filter(e => e.type === 'soulless_cell' && e.metadata.batchId === batchId);
...
exports.SoullessCellHandler = SoullessCellHandler;
//# sourceMappingURL=SoullessCellHandler.js.map