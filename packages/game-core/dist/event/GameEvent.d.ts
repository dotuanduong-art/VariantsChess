...
export type GameEventType = 'OnTurnStart' | 'OnTurnEnd' | 'OnBeforeMove' | 'OnMove' | 'OnBeforeCapture' | 'OnCapture' | 'OnPieceDeath' | 'OnPieceSpawn' | 'OnCheck' | 'OnPieceAttacked' | 'OnSkillUsed' | 'OnEffectApplied' | 'OnEffectExpired' | 'OnEffectTick' | 'OnAPGained' | 'OnAPSpent' | 'OnPawnPromotion' | 'OnGameOver' | 'OnBeforePieceDestroyed' | 'OnPieceDestroyed';
...
export declare function createOnCaptureEvent(turnNumber: number, activePlayer: Color, attackerId: string, capturedPieceId: string, from: any, to: any): GameEvent;
...
export declare function createOnSkillUsedEvent(turnNumber: number, activePlayer: Color, skillId: string, targets: any[]): GameEvent;
