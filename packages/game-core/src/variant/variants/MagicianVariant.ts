...
import { PositionSwapHandler } from '../../effect/handlers/PositionSwapHandler';
import { MovesetSwapHandler } from '../../effect/handlers/MovesetSwapHandler';
import { FoolHandler } from '../../effect/handlers/FoolHandler';
import { APCostConfig } from '../apCostConfig';

export const MagicianVariant: VariantDefinition = {
  id: 'magician',
  name: 'Magician',
  ...
  skills: [
    // ── Skill 1: Now You See Me (4 AP) ──
    {
      ...
      tier: 'skill1',
      apCost: APCostConfig.magician.magician_skill_1,
      cooldown: 0,
    ...
    // ── Skill 2: Misdirection (7 AP) ──
    {
      ...
      tier: 'skill2',
      apCost: APCostConfig.magician.magician_skill_2,
      cooldown: 0,
      usageRule: 'once_per_turn',
    ...
    // ── Ultimate: Carnival of Fools (12 AP) ──
    {
      ...
      tier: 'ultimate',
      apCost: APCostConfig.magician.magician_ultimate,
      cooldown: 0,
      usageRule: 'once_per_turn',
