          ...
          {!selectedMenu ? (
            ...
            menuItems.map((item) => (
              <button
                ...
                className="relative flex items-center text-left transition-all duration-200 px-6 py-3 rounded-none text-[#d4cbb8] hover:text-white border-[3px] border-transparent hover:border-[#d8c39e]/50 hover:bg-white/5"
            ...
            <div className="flex flex-col items-start gap-6 animate-in fade-in slide-in-from-left-4 duration-300">
              ...
              {selectedMenu === 'Join Room' && (
                <div className="flex flex-col gap-4 w-full">
                  ...
                  />
                  <button
                    className="w-full bg-[#d8c39e] hover:bg-[#bda57b] text-black px-4 py-3 border-2 border-[#d8c39e] text-lg transition-colors disabled:opacity-50 disabled:bg-gray-600 disabled:text-gray-300 disabled:border-gray-600"
                    onClick={handleJoin}
              ...
              {selectedMenu === 'Create Room' && (
                <div className="flex flex-col gap-4 w-full">
                  ...
                  <button
                    className="w-full bg-[#d8c39e] hover:bg-[#bda57b] text-black px-4 py-3 border-2 border-[#d8c39e] text-lg transition-colors"
                    onClick={() => createRoom()}
                  >
                    START HOSTING
                  </button>
              ...
              <button
                ...
                className="mt-4 flex items-center gap-2 text-[#94a3b8] hover:text-white transition-colors text-sm"
              >
